...
const VideoCard = (props) => {
    ...
    return (
        <div data-aos={aosState.status ? "fade-up" : null} className="video-card">
            ...
            <p>{languageState.songName} {props.propsSongData.name.length > 24 ? props.propsSongData.name.slice(0,24) + "..." : props.propsSongData.name}</p>
            {props.propsSongData.movie === "No-result" ? <p>{languageState.singer} {props.propsSongData.singer}</p> : <p>{languageState.movie} {props.propsSongData.movie.length > 24 ? props.propsSongData.movie.slice(0,24) + "..." : props.propsSongData.movie}</p>}
